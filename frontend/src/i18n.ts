...
const zh = {
  ...
  accounts: {
    ...
    recoveryEmailSection: "恢复邮箱",
    recoveryEmailStatus: "状态",
    recoveryEmailSet: "已设置",
    recoveryEmailNone: "未设置",
    recoveryEmailPending: "待确认",
    recoveryEmailPendingHint: "验证码已发送至 {pattern}，请输入代码完成确认",
    recoveryEmailReveal: "查看邮箱",
    recoveryEmailRevealPwd: "输入 2FA 密码以查看",
    recoveryEmailChange: "更改邮箱",
    recoveryEmailSet2: "设置恢复邮箱",
    recoveryEmailRemove: "移除邮箱",
    recoveryEmailNewEmail: "新邮箱地址",
    recoveryEmailCurrentPwd: "当前 2FA 密码",
    recoveryEmailConfirmCode: "确认码",
    recoveryEmailConfirm: "确认邮箱",
    recoveryEmailCancel: "取消待确认邮箱",
    recoveryEmailResend: "重新发送",
    recoveryEmailDone: "恢复邮箱已更新",
    recoveryEmailRemoved: "恢复邮箱已移除",
    recoveryEmailConfirmed: "邮箱确认成功",
    recoveryEmailCancelled: "已取消",
    recoveryEmailNoPassword: "请先启用 2FA 密码后再设置恢复邮箱",
...
const en: typeof zh = {
  ...
  accounts: {
    ...
    recoveryEmailSection: "Recovery Email",
    recoveryEmailStatus: "Status",
    recoveryEmailSet: "Set",
    recoveryEmailNone: "Not set",
    recoveryEmailPending: "Pending confirmation",
    recoveryEmailPendingHint: "A code was sent to {pattern} -- enter it below to confirm",
    recoveryEmailReveal: "Reveal email",
    recoveryEmailRevealPwd: "Enter 2FA password to reveal",
    recoveryEmailChange: "Change email",
    recoveryEmailSet2: "Set recovery email",
    recoveryEmailRemove: "Remove email",
    recoveryEmailNewEmail: "New email address",
    recoveryEmailCurrentPwd: "Current 2FA password",
    recoveryEmailConfirmCode: "Confirmation code",
    recoveryEmailConfirm: "Confirm email",
    recoveryEmailCancel: "Cancel pending",
    recoveryEmailResend: "Resend code",
    recoveryEmailDone: "Recovery email updated",
    recoveryEmailRemoved: "Recovery email removed",
    recoveryEmailConfirmed: "Email confirmed",
    recoveryEmailCancelled: "Cancelled",
    recoveryEmailNoPassword: "Enable 2FA first to set a recovery email",
