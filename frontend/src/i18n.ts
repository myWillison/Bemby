...
const zh = {
  ...
  jobs: {
    ...
    autoreg: {
      ...
      labelPreArm: "预先打开注册对话",
      preArmHint: "启动时先发送命令并点击注册按钮，注册码一出现立即发送，速度最快",
...
const en: typeof zh = {
  ...
  jobs: {
    ...
    autoreg: {
      ...
      labelPreArm: "Pre-open the registration dialogue",
      preArmHint: "Send the command and click the register button up front, so a code is sent the instant it appears. Fastest option.",
