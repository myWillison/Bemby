...
const zh = {
  ...
  jobs: {
    ...
    playbackRulesHint: '播放从剧集的随机 5–10% 位置开始，时长为设定时间加上 0–10% 的随机延长。',
...
const en: typeof zh = {
  ...
  jobs: {
    ...
    markWatchedHint: 'After playback completes, mark the episode as watched in Emby',
    playbackRulesHint: 'Playback starts at a random 5–10% into the episode. Duration is the set time plus 0–10% random extra.',
