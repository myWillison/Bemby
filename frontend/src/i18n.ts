...
const zh = {
  ...
  jobs: {
    ...
    autoreg: {
      ...
      successContainsHint: "机器人回复含该文字时视为注册码有效，留空则任意非失败回复均视为有效",
      failContainsPlaceholder: "例：已被使用",
      failContainsHint: "机器人回复含该文字时视为注册码已被使用，立即尝试下一个",
    },
    custom: {
      actions: "动作链",
      addAction: "添加动作",
...
const en: typeof zh = {
  ...
  jobs: {
    ...
    autoreg: {
      ...
      successContainsHint: "Reply text marking the code as accepted; blank treats any non-fail reply as accepted",
      failContainsPlaceholder: "e.g. already used",
      failContainsHint: "Reply text marking the code as used; the next code is tried immediately",
    },
    custom: {
