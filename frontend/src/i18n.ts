...
const zh = {
  ...
  jobs: {
    ...
    autoreg: {
      ...
      codePrefixHint: "注册码的固定前缀，从前缀到行尾即为完整注册码；支持 * 通配符，例：NONAY-*-Register_ 可匹配任意天数",
      labelRegisterButton: "注册按钮文字",
      registerButtonPlaceholder: "例：使用注册码",
...
const en: typeof zh = {
  ...
  jobs: {
    ...
    autoreg: {
      ...
      codePrefixHint: "Fixed prefix of a code; everything from the prefix to the end of the line is the code. Supports * as a wildcard, e.g. NONAY-*-Register_ matches any duration",
      labelRegisterButton: "Register button text",
      registerButtonPlaceholder: "e.g. 使用注册码",
      ...
      failContainsPlaceholder: "e.g. 已被使用",
