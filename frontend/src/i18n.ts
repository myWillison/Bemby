...
const zh = {
  ...
  accounts: {
    ...
    passkeyNotSupported: "通行密钥管理暂不支持（需要官方 Telegram 客户端）",
...
const en: typeof zh = {
  ...
  accounts: {
    ...
    passkeyNotSupported: "Passkey management requires the official Telegram client and is not available here",
    spam: {
      free: "Free",
      limited: "Limited",
      blocked: "Blocked",
